...
docker build --rm -t docker-symfony2/apache multiple-containers/apache/
docker build --rm -t docker-symfony2/mysql multiple-containers/mysql/
docker build --rm -t docker-symfony2/app multiple-containers/app/
